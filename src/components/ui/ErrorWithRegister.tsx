...
// -=== {'CARA ERROR HANDLING MENGGUNAKAN VANILLA RHF RULES (REGISTER)'} ===-
...
const ErrorWithRegister = () => {
  const {
    register,
    handleSubmit,
    formState: { errors },
  } = useForm<LoginForm>({
    mode: 'onChange', // default validasi RHF ('onChange': live/realtime)
  });
...
export default ErrorWithRegister;
